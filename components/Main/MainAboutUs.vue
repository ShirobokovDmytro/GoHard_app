...
<style scoped>
  .about__us{
    width: 100%;
    height: 510px;
    background-image: url(@/assets/main/bg_about.jpg);
  ...
  .left__container__button:hover{
    background-color: #228A43;
  }
  .about__us__right__container{
    width: 50%;
    display: flex;
    justify-content: center;
    align-items: center;
